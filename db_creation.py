...
# Function to create production table
def create_production_table_2():
    create_table_sql = """
        CREATE TABLE IF NOT EXISTS raw_messages_cleaned_weather (
            device_id VARCHAR(255),
            datetime TIMESTAMP,
            address_ip VARCHAR(255),
            address_port INT,
    ...
    """
    drop_table_sql = "" # DROP TABLE IF EXISTS raw_messages_cleaned_weather;   Optional table drop logic
    manage_database("PRODUCTION_KEY", create_table_sql, drop_table_sql)
